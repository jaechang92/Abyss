...
namespace Anim.Core
{
    ...
    public interface IAnimationDriver
    {
        ...
        /// <summary>
        /// 현재 클립의 재생 진행도. 0 = 첫 프레임, 1 = 한 바퀴.
        /// 루프는 1을 넘어 계속 늘고, 한 번 재생도 멈춘 뒤 1을 넘어 있을 수 있다 —
        /// <b>되감을지 붙잡을지는 읽는 쪽이 정한다.</b>
        ///
        /// 🔑 <b>읽기 전용으로만 둔다.</b> 무기 소켓처럼 "지금 몇 번째 프레임인가"가 필요한 것들이
        /// <c>Animator</c>를 직접 붙잡으면, 이 인터페이스가 없애려던 <b>판단자 둘</b>이 다시 생긴다.
        /// </summary>
