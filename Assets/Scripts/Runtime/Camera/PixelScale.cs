namespace Abyss.Runtime.Camera
{
    ...
    public static class PixelScale
    {
        ...
        /// 폼 스프라이트    128       0.75        옛 자산(2026-08-20 손그림). 픽셀아트로 다시 그릴 것
        ...
        /// </code>
        ///
        /// ⚠️ <b>캐릭터를 어느 격자에 그릴지는 아직 안 정해졌다.</b> 환경과 같은 32 일지
        /// 캐릭터만 더 촘촘히 갈지는 <b>캐릭터 단계 바이블(`10_BIBLE/08-silhouette.md`)이 정한다</b> —
        /// `04-palette.md §5` 가 「폼 몸 색을 램프 어디에 두나」를 같은 곳으로 미뤄 둔 것과 한 자리다.
        /// 정해지면 `FormSpriteImporter`·`PrefabBuilder.Enemies` 를 그 값으로 갱신한다.
        /// </summary>
